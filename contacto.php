...
<label id="email">Email: <input id="email" name="email" type="text"
required /></label>
<label id="mensaje">Mensaje: <textarea id="mensaje" name="mensaje"
required rows="5" cols="40"></textarea></label>
